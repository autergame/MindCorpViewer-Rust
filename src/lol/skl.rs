...
#[inline(never)]
pub fn read_skl(contents: &Vec<u8>) -> Skeleton {
    ...
    let mut skeleton = match Type::from_u32(stype) {
        Type::Classic => read_classic(&mut reader, version),
        Type::Version2 => read_version2(&mut reader, version),
    };
...
fn read_version2(reader: &mut Cursor<&Vec<u8>>, version: u32) -> Skeleton {
    ...
    for _ in 0..bone_count {
        ...
        let local_matrix = glam::Mat4::from_scale_rotation_translation(scale, rotation, position);
